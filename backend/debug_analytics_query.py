#!/usr/bin/env python3
"""
Debug script to test the exact analytics query.
"""
...
def debug_analytics_query():
    ...
    try:
        ...
        # Test 1: Get all sales (no filters) - without created_at column
        ...
        # Test 3: Check if any sales have non-zero amounts
