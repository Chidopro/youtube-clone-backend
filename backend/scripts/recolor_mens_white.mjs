/**
 * Recolor Men's Tools mockups to white flats and punch out the studio grey
...
const JOBS = [
  { src: 'mensunisextshirtpreview.png', dest: 'mensunisextshirtpreview2.png' },
  { src: 'mensfittedtshirtpreview.png', dest: 'mensfittedtshirtpreview2.png' },
  { src: 'mensunisexoversizedtshirtpreview.png', dest: 'mensunisexoversizedtshirtpreview2.png' },
  { src: 'menstanktoppreview.png', dest: 'menstanktoppreview2.png' },
  { src: 'mensfittedlongsleeveshirtpreview.png', dest: 'mensfittedlongsleeveshirtpreview2.png' },
  { src: 'mensunisexhoodiepreview.png', dest: 'mensunisexhoodiepreview2.png' },
  { src: 'mensunisexchampionhoodiepreview.png', dest: 'mensunisexchampionhoodiepreview2.png' },
  { src: 'menslongsleeveshirtpreview6.png', dest: 'menslongsleeveshirtpreview7.png' },
];
