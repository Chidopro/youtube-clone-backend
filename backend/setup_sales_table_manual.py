#!/usr/bin/env python3
"""
Manual setup script for the sales table in ScreenMerch database.
...
def setup_sales_table():
    ...
    supabase_key = getpass.getpass("Service Role Key: ").strip()
    ...
    try:
        ...
        # Execute the SQL statements using raw SQL
