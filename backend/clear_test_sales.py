...
3. Clear all sales and orders data
4. Verify the reset
"""
...
def show_current_data():
    ...
    try:
        ...
        return len(sales_result.data), len(orders_result.data)
...
def main():
    ...
    print("🚀 ScreenMerch Sales Data Reset Tool")
    print("=" * 50)
    ...
    # Show current data
    sales_count, orders_count = show_current_data()
