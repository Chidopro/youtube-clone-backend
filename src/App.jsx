  ...
  useEffect(() => {
    ...
    if (loginStatus === 'success' && userData) {
      try {
        ...
        // Ask for user confirmation before auto-signing in
        const confirmed = window.confirm(
          `Welcome back, ${user.display_name}! Would you like to sign in to your account?`
        );
        ...
        if (confirmed) {
          ...
          // No need for additional alert - the confirmation dialog was enough
        } else {
          // User declined, clear any existing auth data
