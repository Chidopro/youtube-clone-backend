    ...
    items: [
      {
        ...
        a: 'The storefront owner opens Dashboard → Umbrella (My Creators), enters the invitee’s email or ScreenMerch username, and clicks Send invite. Email invites create a join link the owner copies and emails (ScreenMerch does not email the link automatically). Username invites go to people who already have a ScreenMerch account; they accept under Channel invites in the profile menu. The owner should set a subdomain in Personalization before sending email invites, since join links use that storefront address.',
      },
      {
