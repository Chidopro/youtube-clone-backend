...
const ProductPage = ({ sidebar }) => {
  ...
  const getStaticProductsForCategory = (category) => {
    ...
    const productImageMap = {
      ...
      "Fitted Racerback Tank": { filename: "womenstank.png", preview: "womenstanktoppreview.png", price: 20.95 },
      ...
      "Women's Shirt": { filename: "womenshdshirt.png", preview: "womenshdshirtpreview.png", price: 23.69 },
      "Unisex Heavyweight T-Shirt": { filename: "womensshirt.png", preview: "womensshirtpreview.png", price: 25.29 },
      "Unisex Pullover Hoodie": { filename: "unisexpulloverhoodie.png", preview: "unisexpulloverhoodiepreview.png", price: 41.06 },
      "Women's Crop Top": { filename: "womens-crop-top.png", preview: "womens-crop-top.png", price: 28.55 },
