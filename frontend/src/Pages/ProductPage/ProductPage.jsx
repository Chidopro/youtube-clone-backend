...
const ProductPage = ({ sidebar }) => {
  ...
  const getStaticProductsForCategory = (category) => {
    ...
    const productImageMap = {
      ...
      "Women's Shirt": { filename: "womenshdshirtpreview.png", preview: "womenshdshirtpreview.png", price: 23.69 },
      "Unisex Heavyweight T-Shirt": { filename: "womenshirtpreview.png", preview: "womenshirtpreview.png", price: 25.29 },
