#!/usr/bin/env python3
"""
Debug the fresh product that's showing blank
"""
import requests

def debug_fresh_product():
    product_id = "67282a3b-09c4-4974-9675-b2fa5c947f9b"
    print(f"🔍 Debugging fresh product: {product_id}")
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            # Check the first 500 characters of the content
